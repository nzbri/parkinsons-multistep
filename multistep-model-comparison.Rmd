...
```{r model_linear_simpler, message=FALSE}
...
# A Bayesian linear fit using the stan_glm function from the rstanarm library
# Use to calculate a R2 of the linear model

fit_linear_stan_glm <- stan_glm(
  middle_log~agecut5_scaled,
  data = sim_df_ms_model,
  chains = 4,
  refresh = 0
)

fit_linear_rsq <- bayes_R2(fit_linear_stan_glm)
print(median(fit_linear_rsq))
...
ggsave("plots/multistep-figure-2.png",width=4,height=7,dpi=1200)
...
ggsave("plots/multistep-figure-3.png",width=4,height=5,dpi=1200)
...
ggsave("plots/multistep-figure-4.png",width=4,height=8,dpi=1200)
